...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 18, 2025 at 05:21 AM
...
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Comentarios';
...
CREATE TABLE IF NOT EXISTS `imagenes` (
  ...
  PRIMARY KEY (`id`),
  KEY `noticia_id` (`noticia_id`)
) ENGINE=MyISAM AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Imagenes';
...
(73, 51, '../imagenDB/6879d62949b2e-rey.png', 'image/png'),
(74, 51, '../imagenDB/thumb_6879d62949b2e-rey.png', 'image/png'),
(75, 51, '../imagenDB/6879d6295e5d5-IMG_20240628_160751.jpg', 'image/jpeg'),
(76, 51, '../imagenDB/6879d6295e9e7-IMG_20211102_120432.jpg', 'image/jpeg');
...
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Noticias';
...
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Usuarios';
...
(32, 'admin', 'admin', 'admin', '$2y$10$Bkkpu/8ST2gz9WX/ynCcGOOcA/OXYDeWQctnFHVha/NVYBT3PfUXi', 'admin', 1, '2025-07-17 19:37:32', '2025-07-17 19:38:08'),
...
(34, 'publicador', 'publicador', 'publicador', '$2y$10$o7PHmS.l4dos.IE20Nx.yuGK6ck19T7LqjjWePJWfVtI237H1tSSO', 'editor', 1, '2025-07-17 19:42:57', '2025-07-17 23:41:12'),
(35, 'Balatro ', 'Balatrez', 'Balatro Balatrez', '$2y$10$pBReWC3vWt403Q27KvyUaeAJ.0dGeHXsc8lALaEYVE2wwZRFV2MNG', 'global', 1, '2025-07-17 19:43:40', '2025-07-17 19:43:40'),
(36, 'global', 'global', 'global', '$2y$10$45TTO8q8KDj5L4c8dqF2t.7kfJBirtHN3U2jpZZpm2lp2.Ru3aNqe', 'global', 1, '2025-07-17 19:44:03', '2025-07-17 19:44:03'),
(37, 'Vlastos', 'Kr', 'V.kr', '$2y$10$2uLFL4ERguyYN4Fi3oMwtekgzw347.6ZbQ6mE54d2wZAAhg9l4Jtu', 'global', 1, '2025-07-17 20:19:11', '2025-07-17 20:19:11');
