...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 14, 2025 at 12:06 AM
...
(28, 'Selección de Panamá se prepara para eliminatorias', 'La selección nacional de fútbol intensifica sus entrenamientos de cara a las próximas eliminatorias mundialistas. El técnico Thomas Christiansen ha convocado a las principales figuras del equipo, incluyendo a jugadores que militan en ligas europeas.', 1, '2025-07-11 23:05:32', NULL, NULL),
(29, 'Festival de Jazz en Casco Antiguo', 'Este fin de semana el Casco Antiguo será sede del Festival Internacional de Jazz de Panamá 2025. El evento contará con la participación de reconocidos artistas nacionales e internacionales. Los conciertos se realizarán en la Plaza Herrera y varios lugares históricos del área.', 1, '2025-07-11 23:05:32', NULL, NULL),
(30, 'Nuevo Metro de Panamá inicia operaciones', 'La Línea 3 del Metro de Panamá comenzó sus operaciones comerciales hoy, conectando el área oeste con el centro de la ciudad. El proyecto, que representa una inversión de más de $2,500 millones, beneficiará a más de 400,000 usuarios diarios. El sistema cuenta con la más moderna tecnología de transporte masivo y reducirá significativamente los tiempos de viaje.', 1, '2025-07-11 23:05:36', NULL, NULL),
(31, 'Panamá clasifica a los Juegos Olímpicos 2024', 'La selección nacional de fútbol intensifica sus entrenamientos de cara a las próximas eliminatorias mundialistas. El técnico Thomas Christiansen ha convocado a las principales figuras del equipo, incluyendo a jugadores que militan en ligas europeas.', 1, '2025-07-11 23:05:36', 1, NULL),
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Usuarios';
